    ...
    <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
        <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="rounded overflow-hidden shadow-lg">
                        ...
                        <div class="relative">
                            <a href="/Tmain/<?php echo e($test->name); ?>">
                                <img class="w-full h-[200px] mx-auto " 
                                    src="<?php echo e(asset('img/' . $test->name . '.jpg')); ?>"
                                    alt="Sunset in the mountains">
                                <div class="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
                            </a>
                            <a href="/Tmain/<?php echo e($test->name); ?>">
                                <div class="absolute bottom-0 left-0 bg-yellow-500 px-4 py-2 text-white text-sm hover:bg-white hover:text-red-600 transition duration-500 ease-in-out">
                                    Photos
                                </div>
                            </a>
                            
                                <div class="text-sm absolute top-0 right-0 p-2 bg-yellow-500 px-4 text-white rounded-full h-16 w-16 flex flex-col items-center justify-center mt-3 mr-3 hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
                                    <span class="font-bold"></span>
                                    <a href="/test/mathematics"> <small><?php echo e($test->type); ?></small> </a>
                                </div>
                            
                        </div>
                        <div class="px-6 py-4">
                            <a href="#" class="font-semibold text-lg inline-block hover:text-yellow-600 transition duration-500 ease-in-out"><?php echo e($test->name); ?></a>
                            <p class="text-gray-500 text-sm"><?php echo e($test->dis); ?></p>
                        </div>
       ...
       <!-- social media -->
       <ul class="flex justify-center space-x-5 p-24 bg-black">
                    <li>
...
</html><?php /**PATH C:\Users\User\Herd\game\resources\views/Turkey/main.blade.php ENDPATH**/ ?>