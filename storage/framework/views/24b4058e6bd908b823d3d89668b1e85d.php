    ...
    <section id="home" class="hero-section min-h-screen flex items-center justify-center relative mt-14">
        ...
        <div class="text-center z-10 max-w-4xl mx-auto px-6">
            ...
            <h1 class="text-6xl md:text-8xl font-bold mb-6 flex ">
                ...
                <div>
                     <img src="<?php echo e(asset('img/char1.png')); ?>" alt="Profile" class="w-[200px] h-[300px] mx-auto " />
               </div>
            </h1>
            <div class="mb-6">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                     ...
                     <img src="<?php echo e(asset('img/char4.png')); ?>" alt="Profile" class="w-96 h-106 mx-auto  " />
                </div>
...
</html><?php /**PATH C:\Users\User\Herd\game\resources\views/welcome.blade.php ENDPATH**/ ?>