...
<section class=" min-h-screen flex items-center justify-center bg-red-950/100 relative text-white px-6">
  ...
  <div class="m-10 bg-gray-900/70 backdrop-blur-md shadow-2xl p-10 rounded-xl w-full max-w-md z-10">
    <div class="text-center mb-10">
      ...
      <h2 class="text-4xl font-bold neon-glow">Log In</h2>
      <img src="<?php echo e(asset('img/char3.png')); ?>" alt="Profile" class="w-[150px] h-[150px] mx-auto " />
    ...
    <form action="/Login" method="POST" class="space-y-6">
     <?php echo csrf_field(); ?>
      <div>
        ...
        <input type="Name" name="name" class="w-full px-4 py-3 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400" placeholder="Hana balkey" required />
      </div>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="flex justify-between items-center text-sm text-gray-400">
        ...
        <a href="/ForgotPassword" class="text-red-400 hover:underline">Forgot password?</a>
    ...
    <p class="text-sm text-center text-gray-400 mt-6">
      ...
      <a href="/signup" class="text-red-400 hover:underline">Sign up</a>
    </p>
  </div>
</section>

</body>
</html><?php /**PATH C:\Users\User\Herd\game\resources\views/register/Login.blade.php ENDPATH**/ ?>