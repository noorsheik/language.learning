...
<section id="home" class="hero-section min-h-screen flex items-center justify-center relative mt-14">
    ...
    <div class="text-left z-10 max-w-4xl mx-auto px-6">
        ...
        <h1 class=" mt-10 text-6xl md:text-8xl font-bold mb-6 flex flex-col md:flex-row items-start gap-4">
              <div>
                <img src="<?php echo e(asset('img/char5.png')); ?>" alt="Profile" class="w-[300px] h-[500px]" />
            </div>
            <?php if(empty(Session::get('eLevel'))): ?>
            <div>
                <span class="gradient-text">English</span><br>
                <span class="neon-glow">Learner Test </span>
                <span class="text-xl sm:flex-row"><br>Games tp develop your skills in English......
            ...
            <?php else: ?>
              <div>
                <span class="gradient-text">English</span><br>
                <span class="neon-glow">Learner <?php echo e(Session::get('eLevel')); ?> Games</span>
                <span class="text-xl sm:flex-row"><br>Games tp develop your skills in English
               </span>
            </div>
            <?php endif; ?>
        ...
        <div class=" flex flex-col sm:flex-row gap-4 justify-start mb-6">
                ...
                <a href="/eTest" class="bg-gradient-to-r from-yellow-500 to-red-500 px-8 py-4 rounded-full font-semibold hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-yellow-500/25">
                    Geting  Started
                </a>
         ...
         <?php else: ?>
          <div class="flex flex-col sm:flex-row gap-4 justify-start mb-6">
                ...
                <a href="/main" class="bg-gradient-to-r from-yellow-500 to-red-500 px-8 py-4 rounded-full font-semibold hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-yellow-500/25">
                    Geting  Started
                </a>
...
<?php /**PATH C:\Users\User\Herd\game\resources\views/english/prepare.blade.php ENDPATH**/ ?>