...
<body>
  ...
  <div class=" bg-gray-900/70 backdrop-blur-md shadow-2xl p-10 rounded-xl w-full max-w-md z-10 m-10">
    <div class="text-center mb-10">
      ...
      <img src="{{asset('img/char3.png')}}" alt="Profile" class="w-[150px] h-[150px] mx-auto rounded-full  shadow-xl" />
    ...
    <form action="/signup" method="POST" class="space-y-6">
     @csrf
      ...
      <div class="flex justify-between items-center text-sm text-gray-400">
        ...
        {{-- <a href="/forgot-password" class="text-red-400 hover:underline">Forgot password?</a> --}}
