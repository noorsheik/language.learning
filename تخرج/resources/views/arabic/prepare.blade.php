...
<section id="home" class="hero-section min-h-screen flex items-center justify-center relative mt-14">
    ...
    <div class="text-left z-10 max-w-4xl mx-auto px-6">
        ...
        <h1 class=" mt-10 text-6xl md:text-8xl font-bold mb-6 flex flex-col md:flex-row items-start gap-4">
              <div>
                <img src="{{ asset('img/char10.png') }}" alt="Profile" class="w-[400px] h-[500px]" />
            </div>
            @if(empty(Session::get('ALevel')))
            <div>
                <span class="gradient-text">Arabic</span><br>
                <span class="neon-glow">Learner Test </span>
                <span class="text-xl sm:flex-row"><br>Games tp develop your skills in Arabic......
            ...
            @else
              <div>
                <span class="gradient-text">Arabic</span><br>
                <span class="neon-glow">Learner {{Session::get('ALevel')}} Games</span>
                <span class="text-xl sm:flex-row"><br>Games tp develop your skills in Arabic
               </span>
            </div>
            @endif
        ...
        <div class=" flex flex-col sm:flex-row gap-4 justify-start mb-6">
                ...
                <a href="/ATest" class="bg-gradient-to-r from-yellow-500 to-red-500 px-8 py-4 rounded-full font-semibold hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-yellow-500/25">
                    Geting  Started
                </a>
         ...
         @else
          <div class="flex flex-col sm:flex-row gap-4 justify-start mb-6">
                ...
                <a href="/Amain" class="bg-gradient-to-r from-yellow-500 to-red-500 px-8 py-4 rounded-full font-semibold hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-yellow-500/25">
                    Geting  Started
                </a>
